...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fproyecto%2Fproyectocode%2Fproyectofinal%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:104: error: `identifier` expected but `}` found
}
^
...
def itinerarios(
  ...
  def aux(cod1: String, cod2: String): List[Itinerario] = {
    ...
    val its = for {
      ...
      val it = formarItinerario(vuelo, vuelos)
      if (it.head.Dst == cod1) it
      else List(): Itinerario
    }
...
def formarIt(vuelo: Vuelo, vuelos: List[Vuelo], cod1: String) {
  ...
  if(resultado.head.Dst==cod1) resultado
  else List():
}
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.scala$meta$internal$parsers$ScalametaParser$$typeOrInfixType(ScalametaParser.scala:1476)
	scala.meta.internal.parsers.ScalametaParser.typeOrInfixType(ScalametaParser.scala:1480)
	scala.meta.internal.parsers.ScalametaParser.iter$3(ScalametaParser.scala:1720)
	...
	scala.meta.internal.parsers.ScalametaParser.expr(ScalametaParser.scala:1587)
	scala.meta.internal.parsers.ScalametaParser.expr(ScalametaParser.scala:1486)
	scala.meta.internal.parsers.ScalametaParser.$anonfun$funDefRest$1(ScalametaParser.scala:3896)
	scala.meta.internal.parsers.ScalametaParser.autoEndPos(ScalametaParser.scala:368)
	scala.meta.internal.parsers.ScalametaParser.autoEndPos(ScalametaParser.scala:373)
