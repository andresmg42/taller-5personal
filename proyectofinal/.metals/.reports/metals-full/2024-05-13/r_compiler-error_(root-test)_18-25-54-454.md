...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fproyecto%2Fproyectocode%2Fproyectofinal%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:80: error: `identifier` expected but `)` found
def formarIt(vuelo:Vuelo,vuelos:List[Vuelo],cod1:)
                                                 ^
