...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fproyecto%2Fproyectocode%2Fproyectofinal%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:81: error: `=` expected but `)` found
def auxvuelos:List[Vuelo]):Itinerario={
                         ^
...
if (vuelos.isEmpty) List(vuelo):Itinerario
    ...
    vuelos.head::aux(vuelo,vuelos.tail)}
else{
    aux(vuelo,vuelos.tail)
}
}
}
